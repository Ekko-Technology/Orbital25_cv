...
def color_adjust_object(object_img, base_img, target_coordinate, alpha): # alpha determines the degree to color blend
    """
    Adjust the colors of object_img so that its mean color matches
    the mean color of the base image region at target_coordinate.
    """
...
if __name__ == "__main__":
    ...
    base_img = cv2.imread("monster.jpg")
